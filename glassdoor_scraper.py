...
def get_jobs(keyword, num_jobs, verbose,path,slp_time):
    ...
    #url = "https://www.glassdoor.com/Job/jobs.htm?sc.generalKeyword= '+ keyword +' &sc.locationSeoString=san+francisco&locId=1147401&locT=C&radius=100&includeNoSalaryJobs=false"
    driver.get(url)
    jobs = []
